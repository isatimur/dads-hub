...
export const sendCommentNotification = async (
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>${senderName} replied to your post "${postTitle}":</p>
  ...
  await sendEmail({
    to: [recipientEmail],
    subject: `${senderName} replied to your post on DadSpace`,
    html,
  });
};
...
export const sendMentionNotification = async (
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
      <h2>Hey ${recipientName}! 👋</h2>
      <p>${senderName} mentioned you in "${postTitle}"</p>
  ...
  await sendEmail({
    to: [recipientEmail],
    subject: `${senderName} mentioned you on DadSpace`,
    html,
  });
};
